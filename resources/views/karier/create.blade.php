...
@section('namaPage', 'Tambah Lowongan Karier')
        ...
        <div class="card-body">
            ...
            <form action="{{ route('karier.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('responsibilities') is-invalid @enderror tinymce-editor" id="responsibilities"
                        name="responsibilities" rows="8">{{ old('responsibilities') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('qualifications') is-invalid @enderror tinymce-editor" id="qualifications" name="qualifications"
