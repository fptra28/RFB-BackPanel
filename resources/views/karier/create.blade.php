        ...
        <form action="{{ route('karier.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('responsibilities') is-invalid @enderror" 
                          id="responsibilities" name="responsibilities" rows="8">{{ old('responsibilities') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('qualifications') is-invalid @enderror" 
                          id="qualifications" name="qualifications" rows="8">{{ old('qualifications') }}</textarea>
